### Note
This README-file has been written using Claude Code, as I wanted to test how well it works. I really enjoy its structure, so I decided on keeping most of the suggestions.
